# capCollapse Function 
# Looks for consecutive words beginning with capital letters and collapses them into a single word.
# Useful for grouping terms together for use in text mining.
